...
var _Likes = require('../Stream/Likes');
...
var ProfileUsername = function ProfileUsername(props) {
    return _react2.default.createElement(
        'div',
        { style: styles.profileUsernameStyle },
        props.name
    );
};
    ...
    _createClass(Profile, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_ProfileImg2.default, { src: userRecord.profileimg }),
                _react2.default.createElement(_ProfileStats2.default, null),
                _react2.default.createElement(
                    'div',
                    { style: styles.avatarBoxOffset },
                    _react2.default.createElement(_Avatar2.default, { src: userRecord.avatar, mini: false }),
                    _react2.default.createElement(ProfileUsername, { name: userRecord.username })
                ),
