...
var _ProfileImg = require('./ProfileImg.jsx');

var _ProfileImg2 = _interopRequireDefault(_ProfileImg);

var _ProfileStats = require('./ProfileStats.jsx');
...
var _AjaxLoader = require('./AjaxLoader.jsx');

var _AjaxLoader2 = _interopRequireDefault(_AjaxLoader);

var _Followers = require('./Followers.jsx');
    ...
    _createClass(Profile, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match + '/updates', component: _Album2.default }),
                _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match + '/album', component: _Album2.default }),
                _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match + '/followers', component: _Followers2.default }),
                _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match + '/likes', component: _Likes2.default }),
                _react2.default.createElement(_Spacer2.default, null)
            );
        }
    }]);
